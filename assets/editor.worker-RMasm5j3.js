(function() {
	...
	(function(e) {
		...
		class l {
			constructor(e, t) {
				...
				this.emitter = new R(n), t && t.add(this.emitter);
			}
			beginUpdate(e) {
				this._counter++;
			}
	...
	let Ne;
	new te(() => /* @__PURE__ */ new Uint8Array(256));
	var Ee = class e {
		static wrap(t) {
	...
	var Nr = class {
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = ue.getLocales().filter((e) => !ue.getInstance(/* @__PURE__ */ new Set([...t.allowedLocales, e])).isAmbiguous(r));
					return {
						kind: 0,
