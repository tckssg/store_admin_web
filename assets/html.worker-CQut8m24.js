	...
	(function(e) {
		...
		class l {
			constructor(e, t) {
				...
				this.emitter = new C(n), t && t.add(this.emitter);
			}
			beginUpdate(e) {
				this._counter++;
			}
	...
	var Si = class {
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const i = e.codePointAt(0), r = n.ambiguousCharacters.getPrimaryConfusable(i), a = ce.getLocales().filter((e) => !ce.getInstance(/* @__PURE__ */ new Set([...t.allowedLocales, e])).isAmbiguous(i));
					return {
						kind: 0,
